...
begin="=begin"
cut="=cut"
Attribute=({Predicate}({identifier})+);
...
Syntax=(and|cmp|continue|CORE|do|else|elsif|eq|exp|for|foreach|ge|gt|if|le|lock|lt|m|ne|no|or|package|q|qq|qr|qw|qx|sub|tr|unless|until|while|xor|y|\;)
...
{RightBraket} {return BRACES;}
{LeftBraket} {return BRACES;}
...
{Predicate}{identifier} {return ATTRIBUTE;}
{Predicate} { return PREDICATE;}
{identifier}|{digit} {return PROPERTY;}
